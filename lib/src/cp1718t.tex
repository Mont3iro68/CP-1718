...
\start
  ...
  \more
  \ensuremath{\Varid{l}\;\Varid{k}\;(\mathbin{+}\mathrm{1})\mathrel{=}(\mathbin{+}\mathrm{1})}
%
...
%
  ...
  \more
  \ensuremath{\Varid{lk}\comp \alt{\Varid{zero}}{\mathbin{+}\mathrm{1}}\mathrel{=}\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}}\comp (\Varid{id}\mathbin{+}\Varid{lk})}
%
\just\equiv{ Fokkinga }
%
  \ensuremath{\conj{\Varid{fk}}{\Varid{lk}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}}}}}
\qed
\end{eqnarray*}
...
%
  ...
  \more
  \ensuremath{\alt{\Varid{s}\comp \Varid{zero}}{\Varid{s}\comp (\mathbin{+}\mathrm{1})}\mathrel{=}\alt{\mathbin{+}\mathrm{1}}{(\mathbin{+}\mathrm{1})\comp \Varid{s}}}
%
\just\equiv{ Fusão-+, Absorção-+ }
%
  ...
  \more
  \ensuremath{\Varid{s}\comp \alt{\Varid{zero}}{\mathbin{+}\mathrm{1}}\mathrel{=}\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}}\comp (\Varid{id}\mathbin{+}\Varid{s})}
%
\just\equiv{ Fokkinga }
%
...
\begin{eqnarray*}
\start
  \ensuremath{\conj{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}}}}}{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}}}}}}
%
\just\equiv{ Banana-split }
%
  \ensuremath{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}}}\times\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}}}\comp \conj{\Conid{F}\;\p1}{\Conid{F}\;\p2}}}
%
\just\equiv{ Absorção-x, Fusão-x }
%
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Conid{F}\;\p1}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}}\comp \Conid{F}\;\p1}}{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Conid{F}\;\p2}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}}\comp \Conid{F}\;\p2}}}}
%
\just\equiv{ Def \ensuremath{\Conid{Ff}\mathrel{=}\Varid{id}\mathbin{+}\Varid{f}} }
%
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Varid{id}\mathbin{+}\p1}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}}\comp \Varid{id}\mathbin{+}\p1}}{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Varid{id}\mathbin{+}\p2}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}}\comp \Varid{id}\mathbin{+}\p2}}}}
%
\just\equiv{ Absorção-+, Nat-id }
%
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}\comp \p1}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p1}}}{\conj{\alt{\Varid{one}}{\Varid{mul}\comp \p2}}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}\comp \p2}}}}}
%
\just\equiv{ Lei da Troca \ensuremath{\times} 2 }
%
  \ensuremath{\cata{\alt{\conj{\conj{\Varid{one}}{\mathbin{+}\mathrm{1}}}{\conj{\Varid{one}}{\Varid{one}}}}{\conj{\conj{\Varid{mul}\comp \p1}{\mathbin{+}\mathrm{1}\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\mathbin{+}\mathrm{1}\comp \p2}}}}}
%
\just\equiv{ \ensuremath{\mathsf{for}\ \Varid{loop}\ \Varid{base}\mathrel{=}\cata{\alt{\Varid{base}}{\Varid{loop}}}}, Universal-+ }
%
        \ensuremath{\begin{lcbr}\Varid{base}\mathrel{=}\conj{\conj{\Varid{one}}{\mathbin{+}\mathrm{1}}}{\conj{\Varid{one}}{\Varid{one}}}\\\Varid{loop}\mathrel{=}\conj{\conj{\Varid{mul}\comp \p1}{\mathbin{+}\mathrm{1}\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\mathbin{+}\mathrm{1}\comp \p2}}\end{lcbr}} 
\qed
\end{eqnarray*}
