...
&
     \ensuremath{\Conid{MagicNr}\mathbin{*}\times\Conid{MagicNr}\mathbin{*}}
...
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{g}\mathrel{=}\underline{(\mathrm{1.0})}+\conj{((\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{\uparrow})\comp \succ }{\conj{\Varid{id}}{{}\<[85]%
\>[85]{}\Varid{id}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  count = sum . p2  . unB}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
