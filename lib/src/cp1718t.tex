...
\\
\>[B]{}\Varid{inQTree}\;{}\<[10]%
\>[10]{}(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{f}\mathrel{=}\conj{\Varid{one}}{\succ }{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\mathrel{=}{}\<[9]%
\>[9]{}\Varid{flatq}\comp \conj{\Varid{f}}{\Varid{g}}\comp \Varid{unflatq}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
