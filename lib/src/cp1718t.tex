...
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{b})\mathrel{=}{}\<[25]%
\>[25]{}i_1\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;(\Varid{b},\Varid{bc}))\mathrel{=}i_2\;(\Varid{b},\Varid{bc}){}\<[E]%
\\
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           \ar[d]_-{\ensuremath{\Varid{allTransactions}\;\Varid{g}}}
           \ar[r]^-{\ensuremath{\Varid{outBlockchain}}}
&
    \ensuremath{\Conid{Block}\mathbin{+}(\Conid{Block}\times\Conid{Blockchain})}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times}\cata{g}}
\\
...
\column{8}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\map \;(\Varid{id}\times\Varid{sum})\comp \Varid{col}\comp \Varid{cataList}\;\alt{\Varid{nil}}{\Varid{f}}\comp \Varid{allTransactions}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{where}\;\Varid{f}\mathrel{=}\mathsf{conc}\comp ((\mathsf{conc}\comp (\Varid{singl}\times\Varid{singl})\comp \conj{\Varid{id}\times\Varid{negate}\comp \p2}{\p2}\comp (\Varid{id}\times\Varid{swap}))\times\Varid{id}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ar[d]^-{\ensuremath{\Varid{collect}}}
\\
     \ensuremath{\Conid{Transactions}}
&
&
     \ensuremath{(\Conid{Entity}\times\Conid{Value}}{^*}\ensuremath{)}{^*}
           \ar[ll]_-{\ensuremath{\map \;(\Varid{id}\times\Varid{sum})}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           ...
           \ar[r]^-{\ensuremath{\Varid{cataBlockchain}\;\Varid{g}}}
&
    \ensuremath{\Conid{MagicNr}}{^*}
           \ar[d]^-{\ensuremath{\conj{\Varid{id}}{\Varid{nub}}}}
\\
     \ensuremath{\Conid{Bool}}
&
     \ensuremath{\Conid{MagicNr}}{^*} \ensuremath{\times\Conid{MagicNr}}{^*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\mathrel{=}\alt{\uncurry{\uncurry{\Conid{Cell}}}\comp \Varid{assocl}}{\uncurry{\uncurry{\uncurry{\Conid{Block}}}}\comp \Varid{assocl}\comp \Varid{assocl}}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{cataQTree}\;\Varid{g}\mathrel{=}{}\<[16]%
\>[16]{}\Varid{g}\comp \Varid{recQTree}\;(\Varid{cataQTree}\;\Varid{g})\comp \Varid{outQTree}{}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp (\Varid{f}+{}\<[43]%
\>[43]{}\Varid{g})){}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mathbf{where}\;\Varid{g}\mathrel{=}\conj{\p1\comp \p2\comp \p2}{\conj{\p1}{\conj{\p2\comp \p2\comp \p2}{\p1\comp \p2}}}{}\<[E]%
\\
\>[15]{}\hsindent{6}{}\<[21]%
\>[21]{}\Varid{f}\mathrel{=}\Varid{id}\times\Varid{swap}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathit B\mathbin{+}}{QTree^4}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{cataQTree}\;\Varid{g}}}
\\
     \ensuremath{\Conid{QTree}}
&
	 \ensuremath{\mathit B\mathbin{+}\Conid{QTree}}
	 		\ar[l]^-{g=\ensuremath{\Varid{inQTree}\comp (\Varid{f}\mathbin{+}\Varid{g})}}
}
\end{eqnarray*}
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\mathrel{=}\Varid{anaQTree}\;((\Varid{f}+\Varid{id})\comp \Varid{outQTree}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{f}\mathrel{=}\Varid{id}\times((\Varid{i}\mathbin{*})\times(\Varid{i}\mathbin{*})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
     \ensuremath{\Conid{QTree}}
           \ar[u]^-{\ensuremath{\Varid{scaleQTree}\;\Varid{i}}}
	 		     \ar[r]_-{h=\ensuremath{(\Varid{f}\mathbin{+}\Varid{id})\comp \Varid{outQTree}}}
&
   \ensuremath{\mathit B\mathbin{+}\Conid{QTree}}
      \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}}\ana{h}}
}
\end{eqnarray*}
...
\column{15}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;\Varid{f}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\Varid{f}\;(\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a})\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
  \ensuremath{\Varid{f}\;\Varid{k}\;\mathrm{0}\mathrel{=}\Varid{one}}
  \more
  \ensuremath{\Varid{f}\;\Varid{k}\;(\mathbin{+}\mathrm{1})\mathrel{=}\Varid{mul}\comp \conj{\Varid{lk}}{\Varid{fk}}}
  \more
  \ensuremath{\Varid{l}\;\Varid{k}\;\mathrm{0}\mathrel{=}(\mathbin{+}\mathrm{1})}
  \more
  \ensuremath{\Varid{l}\;\Varid{k}\;(\mathbin{+}\mathrm{1})\mathrel{=}(\mathbin{+}\mathrm{1})\comp \Varid{lk}}
%
\just\equiv{Igualdade extensional \ensuremath{\times} 2, Def-Comp, Eq-+}
%
  \ensuremath{\alt{\Varid{fk}\comp \Varid{zero}}{\Varid{fk}\comp (\mathbin{+}\mathrm{1})}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}\comp \conj{\Varid{lk}}{\Varid{fk}}}}
  \more
  \ensuremath{\alt{\Varid{lk}\comp \Varid{zero}}{\Varid{lk}\comp (\mathbin{+}\mathrm{1})}\mathrel{=}\alt{\mathbin{+}\mathrm{1}}{(\mathbin{+}\mathrm{1})\comp \Varid{lk}}}
%
\just\equiv{ Fusão-+, Absorção-+, Cancelamento-x }
%
  \ensuremath{\Varid{fk}\comp \alt{\Varid{zero}}{\mathbin{+}\mathrm{1}}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{lk}}{\Varid{fk}})}
  \more
  \ensuremath{\Varid{lk}\comp \alt{\Varid{zero}}{\mathbin{+}\mathrm{1}}\mathrel{=}\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{fk}}{\Varid{lk}}}
%
\just\equiv{ Fokkinga }
%
  \ensuremath{\conj{\Varid{fk}}{\Varid{lk}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p2}}}}
\qed
\end{eqnarray*}

Após obtermos o \ensuremath{\conj{\Varid{fk}}{\Varid{lk}}}, passamos à demonstração do segundo \ensuremath{\conj{\Varid{g}}{\Varid{s}}}:

\begin{eqnarray*}
\start
  \ensuremath{\Varid{g}\;\Varid{zero}\mathrel{=}\Varid{one}}
  \more
  \ensuremath{\Varid{g}\;(\mathbin{+}\mathrm{1})\mathrel{=}\Varid{mul}\comp \conj{\Varid{s}}{\Varid{g}}}
  \more
  \ensuremath{\Varid{s}\;\Varid{zero}\mathrel{=}\Varid{one}}
  \more
  \ensuremath{\Varid{s}\;(\mathbin{+}\mathrm{1})\mathrel{=}(\mathbin{+}\mathrm{1})\comp \Varid{s}}
%
\just\equiv{Igualdade extensional \ensuremath{\times} 2, Def-Comp, Eq-+}
%
  \ensuremath{\alt{\Varid{g}\comp \Varid{zero}}{\Varid{g}\comp (\mathbin{+}\mathrm{1})}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}\comp \conj{\Varid{s}}{\Varid{g}}}}
  \more
  \ensuremath{\alt{\Varid{s}\comp \Varid{zero}}{\Varid{s}\comp (\mathbin{+}\mathrm{1})}\mathrel{=}\alt{\Varid{one}}{\succ \comp \p2\comp \conj{\Varid{g}}{\Varid{s}}}}
%
\just\equiv{ Fusão-+, Absorção-+, Cancelamento-x }
%
  \ensuremath{\Varid{g}\comp \alt{\Varid{zero}}{\mathbin{+}\mathrm{1}}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})}
  \more
  \ensuremath{\Varid{s}\comp \alt{\Varid{zero}}{\mathbin{+}\mathrm{1}}\mathrel{=}\alt{\Varid{one}}{\mathbin{+}\mathrm{1}\comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})}
%
\just\equiv{ Fokkinga }
%
  \ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}}}}}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
  \ensuremath{\conj{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p2}}}}{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}\comp \p2}}}}}
%
\just\equiv{ Banana-split }
%
  \ensuremath{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p2}}\times\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}\comp \p2}}\comp \conj{\Conid{F}\;\p1}{\Conid{F}\;\p2}}}
%
\just\equiv{ Absorção-x, Fusão-x }
%
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Conid{F}\;\p1}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p2}\comp \Conid{F}\;\p1}}{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Conid{F}\;\p2}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}\comp \p2}\comp \Conid{F}\;\p2}}}}
%
\just\equiv{ Def \ensuremath{\Conid{Ff}\mathrel{=}\Varid{id}\mathbin{+}\Varid{f}} }
%
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Varid{id}\mathbin{+}\p1}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p2}\comp \Varid{id}\mathbin{+}\p1}}{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp \Varid{id}\mathbin{+}\p2}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}\comp \p2}\comp \Varid{id}\mathbin{+}\p2}}}}
%
\just\equiv{ Absorção-+, Nat-id }
%
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}\comp \p1}}{\alt{\mathbin{+}\mathrm{1}}{\mathbin{+}\mathrm{1}\comp \p2\comp \p1}}}{\conj{\alt{\Varid{one}}{\Varid{mul}\comp \p2}}{\alt{\Varid{one}}{\mathbin{+}\mathrm{1}\comp \p2\comp \p2}}}}}
%
\just\equiv{ Lei da Troca \ensuremath{\times} 2 }
%
  \ensuremath{\cata{\alt{\conj{\conj{\Varid{one}}{\mathbin{+}\mathrm{1}}}{\conj{\Varid{one}}{\Varid{one}}}}{\conj{\conj{\Varid{mul}\comp \p1}{\mathbin{+}\mathrm{1}\comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\mathbin{+}\mathrm{1}\comp \p2\comp \p2}}}}}
%
\just\equiv{ \ensuremath{\mathsf{for}\ \Varid{loop}\ \Varid{base}\mathrel{=}\cata{\alt{\Varid{base}}{\Varid{loop}}}}, Universal-+ }
%
        \ensuremath{\begin{lcbr}\Varid{base}\mathrel{=}\conj{\conj{\Varid{one}}{\mathbin{+}\mathrm{1}}}{\conj{\Varid{one}}{\Varid{one}}}\\\Varid{loop}\mathrel{=}\conj{\conj{\Varid{mul}\comp \p1}{\mathbin{+}\mathrm{1}\comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\mathbin{+}\mathrm{1}\comp \p2\comp \p2}}\end{lcbr}} 
\qed
\end{eqnarray*}

Para podermos aplicar a nossa base e o nosso loop, temos de ter um par de tuplos, como a função recebe 4 inteiros sem serem tuplos, temos de utilizar uma função auxiliar \ensuremath{\Varid{flatq}} ou \ensuremath{\Varid{unflaq}} de maneira a retornar os tipos corretos, após aplicar a função demonstrada acima.
...
\column{12}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{base}\mathrel{=}\Varid{flatq}\comp \conj{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{f}\mathrel{=}\conj{\Varid{one}}{\mathbin{+}\mathrm{1}}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g}\mathrel{=}\conj{\Varid{one}}{\Varid{one}}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{flatq}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\mathrel{=}\Varid{flatq}\comp \conj{\Varid{f}}{\Varid{g}}\comp \Varid{unflatq}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{f}\mathrel{=}\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g}\mathrel{=}\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{flatq}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{unflatq}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Comp}\;\Varid{a}\;\Varid{e}\;\Varid{d})\mathrel{=}i_2\;(\Varid{a},(\Varid{e},\Varid{d})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cataFTree}\;\Varid{g}\mathrel{=}{}\<[16]%
\>[16]{}\Varid{g}\comp \Varid{recFTree}\;(\Varid{cataFTree}\;\Varid{g})\comp \Varid{outFTree}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{bimap}\;\Varid{g}\;\Varid{h}\mathrel{=}\Varid{anaFTree}\;(\Varid{baseFTree}\;\Varid{g}\;\Varid{h}\;\Varid{id}\comp \Varid{outFTree}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{g}\mathrel{=}\underline{(\mathrm{1.0})}+\conj{((\Varid{sqrt}\;(\mathrm{2}))\mathbin{\uparrow})\comp \succ }{\conj{\Varid{id}}{{}\<[83]%
\>[83]{}\Varid{id}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{U}\mathbin{+}\mathit C\times(\Conid{FTree}\times\Conid{FTree})}
           \ar[l]^-{\ensuremath{\Varid{inFTree}}}
\\
     \ensuremath{\Conid{Int}}
           \ar[u]^-{\ensuremath{\Varid{generatePTree}\;\Varid{i}}}
           \ar[r]_-{h=\ensuremath{\Varid{g}\comp \Varid{outNat}}}
&
   \ensuremath{\Conid{U}\mathbin{+}\mathit C\times(\Conid{Int}\times\Conid{Int})}
      \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times}(\ana{h}\ensuremath{\times}\ana{h})  }
}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Cor}}
           \ar[d]_-{\ensuremath{\Varid{singletonbag}}}
           \ar[r]^-{\ensuremath{\conj{\Varid{id}}{\Varid{one}}}}
&
    \ensuremath{\Conid{Cor}\times\Varid{one}}
           \ar[d]^-{\ensuremath{\Varid{singl}}}
\\
     \ensuremath{\Conid{Bag}}
&
     \ensuremath{(\Conid{Cor}\times\Varid{one})}{^*}
           \ar[l]_-{\ensuremath{\mathit B}}
}
\end{eqnarray*}

\subsubsection{muB}
Para multiplicarmos Bag's dentro de Bag's para devolver apenas um Bag, primeiro teremos de aplicar um \textit{fmap} que é o functor de bags, para fazermos \textit{unB} aos Bag's que estão no Bag. Após isto, fazemos o \textit{unB} ao Bag, e de seguida aplicamos um \textit{map} a esse Bag e esse map irá aplicar outro \ensuremath{\map } aos Bag's desse Bag multiplicando o valor do Bag de fora com os de dentro. Esse map retorna-nos uma lista de [(a,Int)] daí fazermos o \textit{concat} a esse tipo , e aplicando o construtor \textit{B} ficando assim apenas com um Bag já multiplicado.   

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{concat}\comp \map \;(\Varid{muBAux})\comp \Varid{unB}\comp \mathsf{fmap}\;\Varid{unB}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{muBAux}\mathbin{::}([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\to [\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{muBAux}\;(\Varid{x},\Varid{y})\mathrel{=}\map \;(\Varid{id}\times(\Varid{y}\mathbin{*}))\;\Varid{x}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Bag}\;(\Conid{Bag})}
           \ar[d]_-{\ensuremath{\mu }}
           \ar[r]^-{\ensuremath{\Varid{unB}\comp \mathsf{fmap}\;\Varid{unB}}}
&
    \ensuremath{((\Conid{Cor}\times\Conid{Int})}{^*}\ensuremath{\times\Conid{Int})}{^*}
           \ar[d]^-{\ensuremath{\Varid{concat}\comp \map \;(\Varid{muBAux})}}
\\
     \ensuremath{\Conid{Bag}}
&
     \ensuremath{(\Conid{Cor}\times\Conid{Int})}{^*}
           \ar[l]_-{\ensuremath{\mathit B}}
}
\end{eqnarray*}
...
Para saber a distribuição de cada cor num bag, primeiro temos de calcular o número de berlindes do bag, ou seja somar os berlindes de cada cor, ficando com uma lista só do segundo tuplo, e somando-a temos os berlindes todos de um Bag. Se fizermos um \ensuremath{\conj{\Varid{id}}{\Varid{count}}} obtemos um tuplo sendo o primeiro elemento a lista original do Bag de berlindes e o segundo a contagem de berlindes desse Bag. Depois basta aplicarmos um \ensuremath{\map } à lista que consiste apenas em dividir o número de berlindes de cada cor pelo total de berlindes calculado. Após aplicado o \ensuremath{\map }, temos uma lista de tuplos \textit{(Cor,Float)} e basta-nos aplicar o construtor \textit{D} para obter uma Distribuição.     

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dist}\mathrel{=}\Conid{D}\comp \Varid{distAux}\comp \conj{\Varid{id}}{\Varid{count}}\comp \Varid{unB}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{count}\mathrel{=}\Varid{sum}\comp (\map \;\p2){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{distAux}\mathbin{::}([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\to [\mskip1.5mu (\Varid{a},\Conid{Float})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{distAux}\;(\Varid{x},\Varid{y})\mathrel{=}\map \;(\lambda (\Varid{x1},\Varid{x2})\to (\Varid{x1},\Varid{toFloat}\;(\Varid{x2})\mathbin{/}\Varid{toFloat}\;(\Varid{y})))\;\Varid{x}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{(\Conid{Cor}\times\Conid{Int})}{^*}
           \ar[d]^-{\ensuremath{\conj{\Varid{id}}{\Varid{count}}}}
\\
     \ensuremath{\fun{Dist}}
&
     \ensuremath{((\Conid{Cor}\times\Conid{Int})}{^*}\ensuremath{\times\Conid{Int})}
           \ar[l]_-{\ensuremath{\Conid{D}\comp \Varid{distAux}}}
}
\end{eqnarray*}
